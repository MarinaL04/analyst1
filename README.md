...
<ol>
  <li>Задача №1</li>представить калькулятор юнит-экономики для наглядной оценки прибыльности продукта
  <li>Задача №2.</li>расчет основых метрик юнит экономики, прогноз выручки, выход на требуемый уровень маржинальности
</ol>
...
<p>Выводы (итоги):<p>
<ol>
  <li>Итог №1</li>выыполнен расчет основных метрик юнит-экономики, 
  <li>Итог №2</li>
</ol>
<br> 
